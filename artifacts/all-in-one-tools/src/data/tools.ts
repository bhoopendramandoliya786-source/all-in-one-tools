...
> = {
  ...
  Calculators: {
    label: 'Calculators',
    short: 'Answers for everyday decisions, wealth and loans.',
    icon: 'Calculator',
    color: '#8d6aaf',
  },
  'Generators & Developer Utilities': {
...
export const tools: Tool[] = [
  ...
  ...make('PDF Tools', 'FileText', [
    ['pdf-merge', 'Merge PDF', 'Join multiple PDFs into one clean document.', ['combine pdf', 'pdf jodna', 'join pdf files'], true],
    ['pdf-split', 'Split PDF', 'Break a PDF into smaller files by page range.', ['separate pdf', 'pdf alag karna', 'page splitter'], true],
    ['pdf-compress', 'Compress PDF', 'Make a PDF lighter for sharing and uploads.', ['reduce pdf size', 'pdf chhoti karna', 'under 100kb'], true],
    ['pdf-to-images', 'PDF to Images', 'Turn every page into a downloadable JPG or PNG image.', ['pdf se photo', 'convert pdf to jpg']],
    ['images-to-pdf', 'Images to PDF', 'Bundle JPG/PNG images into a single tidy PDF.', ['photo se pdf', 'jpg to pdf', 'image combine pdf']],
    ['pdf-rotate', 'Rotate PDF', 'Rotate pages by 90 or 180 degrees permanently.', ['turn pdf', 'sidha karna']],
    ['pdf-delete-pages', 'Delete PDF Pages', 'Remove unwanted pages from your document.', ['remove page', 'pdf se page hatana']],
    ['pdf-extract-pages', 'Extract Pages', 'Save selected specific pages as a new PDF.', ['save single page', 'pdf page nikalna']],
    ['pdf-watermark', 'Watermark PDF', 'Stamp light text or brand marks across your document.', ['pdf stamp', 'watermark lagana']],
    ['pdf-metadata-remover', 'Remove Metadata', 'Strip hidden document author and date details.', ['clean pdf', 'clear pdf info']],
  ]),
  ...
  ...make('Image Tools', 'Image', [
    ...
    ['image-resize', 'Resize Image', 'Set exact width and height dimensions in pixels.', ['change photo size', 'passport size dimensions', 'photo resize'], true],
  ...
  ...make('Text Tools', 'Type', [
    ...
    ['character-counter', 'Character Counter', 'Track exact characters with and without spaces.', ['char count', 'letter counter']],
    ['case-converter', 'Case Converter', 'Convert between UPPERCASE, lowercase, Title Case, camelCase.', ['capital letters', 'bada chhota akshar']],
    ['remove-extra-spaces', 'Remove Extra Spaces', 'Clean double spaces, empty tabs, and blank lines.', ['clean spaces', 'space hatana']],
    ['text-sorter', 'Text Sorter', 'Alphabetize lines A-Z or sort by length.', ['alphabetical sort', 'line order']],
    ['duplicate-line-remover', 'Duplicate Line Remover', 'Instantly purge repeating rows or email entries.', ['remove duplicates', 'unique lines']],
    ...
    ['slug-generator', 'Slug Generator', 'Turn headlines and titles into clean URL slugs.', ['url generator', 'seo slug']],
    ['lorem-ipsum-generator', 'Lorem Ipsum Generator', 'Generate clean dummy placeholder text for layouts.', ['dummy text', 'fake copy']],
  ]),

  // ==========================================
  // 4. CALCULATORS (30 Tools = 15 Old + 15 New Financial)
  // ==========================================
  ...make('Calculators', 'Calculator', [
    // --- 15 New High-Demand Financial Calculators ---
    ['sip-calculator', 'SIP Calculator', 'Calculate returns on Monthly Mutual Fund SIP investments.', ['sip calculator', 'mutual fund sip', 'sip me kitna milega', 'crorepati calculator', 'monthly investment'], true],
    ['lumpsum-calculator', 'Lumpsum Calculator', 'Calculate wealth growth on one-time mutual fund investments.', ['one time investment', 'lumpsum return', 'mutual fund lumpsum']],
    ['ppf-calculator', 'PPF Calculator', 'Calculate 15-year Public Provident Fund returns and tax savings.', ['ppf return', 'sarkari yojna', 'ppf interest rate']],
    ...
    ['cagr-calculator', 'CAGR Calculator', 'Calculate Compound Annual Growth Rate for stocks and business.', ['annual growth', 'cagr formula', 'portfolio cagr']],
    ...
    ['fuel-cost-calculator', 'Fuel Cost & Mileage', 'Calculate total trip fuel cost and split per passenger.', ['petrol kharcha', 'mileage hisab', 'diesel cost', 'trip cost']],
    ['inflation-calculator', 'Inflation Calculator', 'See what today money will be worth in 10 or 20 years.', ['mehangai calculator', 'future value of money', 'inflation rate']],
    ...
    ['calorie-calculator', 'Calorie & TDEE Calculator', 'Find your daily maintenance calories for weight loss/gain.', ['daily calories', 'diet plan calories', 'tdee calc']],
    ...
    ['tip-calculator', 'Tip & Bill Splitter', 'Calculate dining tip percentage and split bill evenly with friends.', ['hotel bill split', 'bill barabar batna', 'tip calculation']],

    // --- 15 Original Calculators ---
    ...
    ['age-calculator', 'Age Calculator', 'Find exact age in years, months, and days from birth date.', ['umra calculator', 'exact age'], true],
    ...
    ['gst-calculator', 'GST Calculator', 'Add or deduct 5%, 12%, 18%, or 28% GST from any amount.', ['gst jodna', 'gst hatana'], true],
    ['bmi-calculator', 'BMI Calculator', 'Check Body Mass Index and healthy weight category.', ['vajan check', 'fat calculator']],
    ['discount-calculator', 'Discount Calculator', 'Determine final sale price and total money saved.', ['chhoot nikalna', 'sale offer']],
  ...
  ...make('Generators & Developer Utilities', 'Terminal', [
    ['qr-code-generator', 'QR Code Generator', 'Generate clean, high-resolution QR codes for URLs and text.', ['make qr', 'upi qr code'], true],
    ['password-generator', 'Password Generator', 'Create strong, uncrackable random passwords locally.', ['strong password', 'secure key'], true],
  ...
  ...make('Converters & Other Utilities', 'ArrowLeftRight', [
    ['number-to-words', 'Number to Words', 'Spell out currency or numbers into words in English.', ['cheque writing', 'amount in words']],
